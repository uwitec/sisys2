...
<%	
	...
	if(error == null) {
		...
		error = "操作失败，请检查后重试！";
	} else if(error.equals("doutofline")) {
		error = "删除工单后，则产生逻辑错误，请检查后重试！";
	} else if(error.equals("aoutofline")) {
		error = "修改工单后，则产生逻辑错误，请检查后重试！";
	} else if(error.equals("asuccess")) {
		error = "修改成功！";
	} else if(error.equals("dsuccess")) {
		error = "删除成功！";
	}
