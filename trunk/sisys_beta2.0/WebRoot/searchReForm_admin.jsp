			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						 <form id="myForm" href="ReFormSearch_admin.jsp?current=workForm">
    	<label>
    		<%=error%>
    	</label>
    	
    	<table>
    		<form href="ReFormSearch_admin.jsp?current=workForm">
    		<tr>
    		...
    		<tr>
    			<td><a class="button" type="button" href="ReFormSearch_admin.jsp?current=workForm" >提交</a></td>
