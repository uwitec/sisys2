								 ...
								 %>
									<tr>
										...
										<!-- Icons -->
											...
											<a href="editBackForm.action?id=<%=bwf.getId() %>" title="编辑工单"><img src="resources/images/icons/pencil.png" alt="编辑工单" /></a>
										    <a href="deleteBackForm.action?id=<%=bwf.getId() %>" title="删除工单" onclick="return confirm('确实要删除吗？');"><img src="resources/images/icons/cross.png" alt="删除工单" /></a>
										     <a href="showBackForm.action?id=<%=bwf.getId() %>" title="查看详情"><img src="resources/images/icons/hammer_screwdriver.png" alt="查看详情" /></a>
