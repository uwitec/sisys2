...
<!--[if lte IE 7]>
		...
		<script type="text/javascript">
			function loadTime(){
				document.getElementsByName("batch.startTime")[0].value = "<%=startTime%>";
				document.getElementsByName("batch.endTime")[0].value = "<%=endTime%>";
					...
					<div id="login-content">
						...
						<table class="">
								...
								<tr>
									...
									<td><input type="text" width="50px"  name="batch.startTime" onClick="WdatePicker()"></td>
									<td><span>结束时间</span></td>
									<td><input type="text" width="50px" name="batch.endTime" onClick="WdatePicker()"></td>
								</tr>
								<tr>
