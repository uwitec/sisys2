				...
				<div class="content-box-content">
							...
							<p>
								<label>表格类型</label> <select name="time" id="time"
									...
									<option value="SearchProduct_viewer.jsp?current=sheet">产品废品统计表</option>
									<option value="SearchProduct2_viewer.jsp?current=sheet">批次某产品废品统计表</option>
									<option selected="selected" value="SearchProduct3_viewer.jsp?current=sheet">员工废品统计表</option>
									<option value="SearchProduct4_viewer.jsp?current=sheet">部门废品统计表</option>
									<option value="SearchProduct5_viewer.jsp?current=sheet">生产线废品统计表</option>
								</select>
							</p>
						<div align="center">
							<label>
					...
					<div id="login-content">
						...
						<s:form action="SearchPd3" target="_blank" namespace="/">
