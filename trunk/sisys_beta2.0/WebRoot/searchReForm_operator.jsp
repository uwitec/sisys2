...
<title>生产物流统计系统</title>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
    	...
    	<table>
    		<form action="ReFormSearch_operator.jsp?current=workForm" method="post">
    		<tr>
    		...
    		<tr>
    			<td><a class="button" type="button" href="ReFormSearch_operator.jsp?current=workForm" >提交</a></td>
